...
<body>
<form action="BoardUpdateAction.do" method="post" name = "freeForm" onsubmit = "return formCheck(this)">
<table class="free-form"  align = "center" border="0">
	...
	<tr>
		...
		<td class="input-form" colspan="3"><c:set var="content" value="${fn:replace(vo.content, '>', '&gt;')}"/>
