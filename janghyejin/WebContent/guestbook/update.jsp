...
<form action="updateOK.jsp" method="post" name = "guestForm" onsubmit = "return formCheck(this)">
<input type="hidden" name="idx" value="${vo.idx}"/>
<input type="hidden" name="currentPage" value="${currentPage}"/>
   <jsp:include page="../top.jsp" flush="false"/>	
<table class="guest_t" width="800" align="center" border="0" style="margin-top: 100px;">
	<tr><th class="guest_head" colspan="2">방명록 수정하기</th></tr>
	<tr>
		<td class="guest_th">아이디</td>
		<td class="guest_td"><input type="text" name="id" readonly="readonly" value="${id}" style="border:0; font-size:13px; font-family: 나눔스퀘어; padding-left: 10px;"/></td>
	</tr>
	<tr>
	<td class="guest_th">이름</td>
		<td class="guest_td"><input type="text" name="name" readonly="readonly" value="${vo.name}" style="border:0; font-size:13px; font-family: 나눔스퀘어; padding-left: 10px;"/></td> 
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="guest_td">
			<textarea rows="10" cols="70" name="content" style="border:1; font-size:13px; font-family: 나눔스퀘어; padding-left: 10px;">${vo.content}</textarea>
		</td> 
	</tr>
	<tr>
