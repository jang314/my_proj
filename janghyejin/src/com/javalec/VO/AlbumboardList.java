...
public class AlbumboardList {
		ArrayList<AlbumboardVO> list = new ArrayList<>();
		...
		public AlbumboardList(int pageSize, int totalCount, int currentPage){
		...
		public ArrayList<AlbumboardVO> getList() {
			return list;
		}

		public void setList(ArrayList<AlbumboardVO> list) {
			this.list = list;
		}
		...
		public String toString() {
			return "AlbumboardList [list=" + list + "]";
		}
