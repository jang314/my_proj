...
public class PagingList {
	...
	private List<UploadVO> list = new ArrayList<UploadVO>();
	private List<UploadComment> commentList = new ArrayList<UploadComment>();
	...
	public PagingList(int pageSize, int totalCount, int currentPage){
	...
	public List<UploadComment> getCommentList() {
		return commentList;
	}
	
	public void setCommentList(List<UploadComment> commentList) {
		this.commentList = commentList;
	}
	
	@Override
	public String toString() {
		return "PagingList [list=" + list + "]";
	}
